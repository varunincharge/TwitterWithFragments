...
public class TwitterClient extends OAuthBaseClient {
    ...
    public void getAtMentions(String since_id, String max_id, AsyncHttpResponseHandler handler) {
    ...
    public void getUserTimeline(String screenName, String since_id, String max_id, AsyncHttpResponseHandler handler) {
